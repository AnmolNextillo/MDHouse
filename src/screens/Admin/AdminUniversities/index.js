...
const AdminUniversities = ({ navigation }) => {
  ...
  const fetchUniversities = async (
    ...
    try {
      ...
      if (reset) {
        ...
        setUniversities((prev) => [...prev, ...list]);
      }
      ...
      console.log("Universities API Error:", e);
    } finally {
      setLoading(false);
      setRefreshing(false);
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      style={styles.card}
      activeOpacity={0.8}
      onPress={() => navigation.navigate("AdminUniversityDetails", { university: item })}
    >
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => navigation.navigate("AdminAddUniversity")}
      >

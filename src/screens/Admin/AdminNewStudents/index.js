...
const AdminNewStudents = ({ navigation }) => {
  ...
  const fetchStudents = async (
    ...
    try {
      ...
      if (reset) {
        ...
        setStudents((prev) => [...prev, ...filteredList]);
      }
      ...
      console.log("Students API Error:", e);
    } finally {
      setLoading(false);
      setRefreshing(false);
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      style={styles.card}
      onPress={() => navigation.navigate("AdminNewStudentDetails", { student: item })}
    >
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerStyle}>
          ...
          <Text style={styles.headerText}>New Students</Text>
        </View>
...
export default AdminNewStudents;